...
const message = buildHelcimInvoiceMessage({
  orderName: '#1010', amount: 118, amountText: '$118.00', currency: 'usd',
...
assert.throws(
  () => buildHelcimInvoiceMessage({ orderName: '#1', amount: 1, amountText: '$1.00', currency: 'USD', paymentUrl: 'https://attacker.example/pay' }),
  /myhelcim\.com/,
);
assert.throws(
  () => buildHelcimInvoiceMessage({ orderName: '#1', amount: 0, amountText: '$0.00', currency: 'USD', paymentUrl: 'https://fuzzywumpets.myhelcim.com/pay' }),
  /positive/,
);
